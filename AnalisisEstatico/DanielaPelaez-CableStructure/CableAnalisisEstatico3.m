function [H,L,Wo,DT, Tmin, To, Tf, Tmax, Tten, Nten, S, Lo, Lf, DTo, DTf, str, x, y, A, B, D, wx, wy] = CableAnalisisEstatico3(H,L,Wo,DT)

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %                                ANÁLISIS ESTÁTICO DE CABLES                                %
    %          CARGAS DISTRIBUIDAS UNIFROMEMENTE A LO LARGO DE LINEAS RECTAS (CCDULLR1)         %
    %                                                                                           %
    ...
    %                                                                                           %
    %  H    = Es la altura desde el punto más bajo del cables hasta el punto F y O   (m)        %
    %  L    = Es la distacia o el vano entre el punto O y el punto F                 (m)        %
    %  Wo   = Es la magnitud de la carga distribuida                                 (KN/m)     %
    ...
    % H: es la flecha o altura desde el punto con de máxima deformación hasta
    % el punto inicial.
    Ho=H;
    % H: es la fleccha o altura desde el punto con de máxima deformación hasta
    % el punto final. por lo tanto el punto inicial y final estan a nivel
    Hf=H;
    ...
    % Sf: Longitud desde el punto con de máxima deformaciòn hasta el punto final.
    ...
    %%
    %%denominación de la herramienta : programa 3
    Programa=3;
    %%
    % fecha y hora
       str = date;
