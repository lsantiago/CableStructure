function [Tmin] = SalidaCableAnalisisEstatico2(Ho,Hf,L,Wo,DT, Tmin, To, Tf, Tmax, Tten, Nten, S, Lo, Lf, DTo, DTf, str, x, y, A, B, D, wx, wy, ruta, nameFileUser, nameFileExperimento)        
    %%
    ...
    fprintf(text_tiket,[  'CASO       :      2   : Ho>Hf : La flecha en el punto O es mayor a la flecha del punto F                           \n']);
    ...
    fprintf(text_tiket,[  '          ------------------------------|-----------|-----------|------------\n']);
    fprintf(text_tiket,[  '           Altura o flecha del punto O  |    Ho     |     m     |  ' num2str(Ho) '\n']);
    fprintf(text_tiket,[  '           Altura o flecha del punto F  |    Hf     |     m     |  ' num2str(Hf) '\n']);
