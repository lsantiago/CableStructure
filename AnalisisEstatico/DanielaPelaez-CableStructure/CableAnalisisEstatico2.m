function [Ho,Hf,L,Wo,DT, Tmin, To, Tf, Tmax, Tten, Nten, S, Lo, Lf, DTo, DTf, str, x, y, A, B, D, wx, wy] = CableAnalisisEstatico2(Ho,Hf,L,Wo,DT)

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %                                ANÁLISIS ESTÁTICO DE CABLES                                %
    %          CARGAS DISTRIBUIDAS UNIFROMEMENTE A LO LARGO DE LINEAS RECTAS                    %
    %                                                                                           %
    ...
    %patch(wx,wy,'r')
    %axis([-L+Lf-DT/2 Lf+DT/2 -Do-DT Ho])
    %axis off

    %%
    %denominación de la herramienta : programa 2 
