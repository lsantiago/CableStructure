function [Tmin] = SalidaCableAnalisisEstatico1(Ho,Hf,L,Wo,DT, Tmin, To, Tf, Tmax, Tten, Nten, S, Lo, Lf, DTo, DTf, str, x, y, A, B, D, wx, wy, ruta, nameFileUser, nameFileExperimento)        
    %%
    ...
    fprintf(text_tiket,[  'CASO       :      1   : Ho<Hf : La flecha en el punto O es menor a la flecha del punto F                           \n']);
